    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                # If email fails, still let them in but warn
                user.email_verified = True
                user.save()
                login(request, user)
                messages.warning(request, f'Welcome, {user.username}! Could not send verification email — account activated directly.')
